    ...
    <section className="py-20 bg-[#f8fafc]">
      <div className="container mx-auto px-4 max-w-[1200px]">
        ...
        <div className="text-center mb-16 md:mb-12">
          <h2 className="text-[40px] md:text-[36px] sm:text-[32px] font-bold text-slate-900 mb-4">
            Complete Marketing Solutions for Accountants, CPAs, and Bookkeepers
          </h2>
          <p className="text-xl md:text-lg sm:text-base text-slate-600 leading-relaxed max-w-[800px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 md:gap-8 sm:gap-6">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="text-[17px] md:text-base sm:text-[15px] text-slate-600 leading-relaxed">
          ...
          >
            <div className="flex flex-col gap-3">
              ...
              <div>
                ...
                <p className="text-base md:text-[15px] sm:text-sm text-slate-600 leading-relaxed">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <h3 className="text-xl md:text-lg font-bold text-slate-900 mb-2">
                Foundation Setup: Strategy + Integration
              </h3>
              <p className="text-base md:text-[15px] text-slate-600 leading-relaxed">
