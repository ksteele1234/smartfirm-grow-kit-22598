        ...
        <div className="max-w-container-2xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <motion.div 
              ...
              variants={fadeInUpVariants}
              transition={{ delay: 0 }}
              className="bg-[#f8fafc] border border-[#e2e8f0] rounded-card-lg p-card shadow-[0_4px_12px_rgba(0,0,0,0.06)] hover:translate-y-[-2px] hover:shadow-[0_6px_16px_rgba(0,0,0,0.1)] transition-all duration-300"
            >
