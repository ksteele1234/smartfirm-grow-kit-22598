  ...
  return (
    <section className="py-section bg-white">
      <div className="container mx-auto px-6">
        <div className="max-w-text-lg mx-auto bg-accent-muted border-2 border-secondary rounded-xl p-6 md:py-8 md:px-10 flex flex-col md:flex-row gap-3 md:gap-5 items-start">
          {/* Icon */}
          <div className="flex-shrink-0">
            <Info className="w-6 h-6 text-secondary" aria-hidden="true" />
          </div>
