/**
 * Single Source of Truth for all deprecated FAQ paths
 ...
 * 
 * @fileoverview Centralized list of deprecated FAQ slugs to prevent DRY violations
 */

// 55 deprecated individual FAQ question slugs
export const DEPRECATED_FAQ_QUESTION_SLUGS = [
...
export const DEPRECATED_FAQ_CATEGORY_SLUGS = [
...
export const ALL_DEPRECATED_FAQ_SLUGS = [
  ...DEPRECATED_FAQ_QUESTION_SLUGS,
  ...DEPRECATED_FAQ_CATEGORY_SLUGS,
] as const;

// Type exports
export type DeprecatedFaqQuestionSlug = typeof DEPRECATED_FAQ_QUESTION_SLUGS[number];
export type DeprecatedFaqCategorySlug = typeof DEPRECATED_FAQ_CATEGORY_SLUGS[number];
export type DeprecatedFaqSlug = typeof ALL_DEPRECATED_FAQ_SLUGS[number];
