...
const GrowthCalculator = () => {
  ...
  return (
    <>
      <SEO 
        title="Accounting Firm Growth Calculator | SmartFirm"
        description="Free accounting firm growth calculator. Input your client count, average fees, and capacity to reveal untapped revenue potential and optimize your client mix."
      ...
      <section className="py-8 bg-gradient-to-b from-primary/80 via-primary/70 to-primary/60">
        <div className="container mx-auto px-4 lg:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-sm max-w-container-content mx-auto">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="grid lg:grid-cols-2 gap-lg items-center max-w-container-2xl mx-auto">
            {/* Left Column - Text */}
            <div className="space-y-6">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 lg:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-md max-w-container-2xl mx-auto items-start">
            {/* Testimonial 1 - Dan */}
      ...
      <section className="py-section px-6">
        <div className="max-w-container-2xl mx-auto flex justify-center">
